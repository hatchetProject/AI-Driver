...
The pre-computed AI-Driver scores for all genome-wide possible missense variants are available at [here](http://aidriver.tania.wang:580/).  

## Download
* Clone and fork code and from this repository.
* Training data is available in the DriverBase folder and 23 features of whole exome for any possible variant can be downloaded [here](http://aidriver.tania.wang:580/download/varcards.main.Phred_scaled.xls.gz).
